...
\newcommand{\LIPStitelsida}{
    ...
    \end{center}
    \begin{center}
        {\large Gabriel Anderberg, Adam Engman, Joakim Stenborg, Kristoffer Gubberud Maras, Didrik Axén}
    \end{center}
    \begin{center}
        {\large \textbf{Version \LIPSversion}}
    \end{center}
    \begin{center}
        {Parts of this document are based on the 2020 user guide for ENVISIoN.}
    \end{center}
    \vfill
    \begin{center}{
        \large Status}\\[1.5ex]
