...
\newcommand{\LIPStitelsida}{
    ...
    \end{center}
    \begin{center}
        \emph{Notering: Delvist innehåll under rubriker: Skrivining till HDF5-fil, Inläsning av VASP-filer, Datastrukturer och Properties och widgets har baserats på 2018 års tekniska dokumentation för visualiseringsvertyget ENVISIoN. Mer info finns i kapitel \ref{sec:provenance}.}
    \end{center}
    \vfill
    \begin{center}{
        \large Status}\\[1.5ex]
